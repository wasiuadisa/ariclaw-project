...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('storage/admin_template/assets/img/favicon.png') }}">
        ...
        <nav class="navbar flex-nowrap p-0">
            <div class="navbar-brand-wrapper d-flex align-items-center col-auto border-right border-dark">
                ...
                <a class="navbar-brand navbar-brand-mobile" href="{{ route('index') }}">
                    <img class="img-fluid w-100" src="{{ asset('storage/admin_template/assets/img/logo.png') }}" alt="{{ config('app.name') }}">
                </a>
                <!-- End Logo For Mobile View -->

                <!-- Logo For Desktop View -->
                <a class="navbar-brand navbar-brand-desktop" href="{{ route('index') }}">
                    <img class="side-nav-show-on-closed" src="{{ asset('storage/admin_template/assets/img/logo-mini.png') }}" alt="{{ config('app.name') }}" style="width: auto; height: 33px;">
                    <img class="side-nav-hide-on-closed" src="{{ asset('storage/admin_template/assets/img/logo.png') }}" alt="{{ config('app.name') }}" style="width: auto; height: 33px;">
                </a>
...
*/ ?>
                ...
                <li class="side-nav-menu-item side-nav-has-menu border-bottom border-light">
                    <a class="side-nav-menu-link media align-items-center" href="#"
                       data-target="#marketingComponents">
                        <span class="side-nav-menu-icon d-flex mr-3">
                            <i class="gd-view-list"></i>
                        </span>
                        <span class="side-nav-fadeout-on-closed media-body">
                            Marketing Pitches & page
                        </span>
                        <span class="side-nav-control-icon d-flex">
                            <i class="gd-angle-right side-nav-fadeout-on-closed"></i>
                        </span>
                    ...
                    <!-- UI Components: subComponents -->
                    <ul id="marketingComponents" class="side-nav-menu side-nav-menu-second-level mb-0" style="display:block;">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('admin.new-marketing-pitch') }}">
                                Create New Pitch
                            </a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('admin.marketing-pitches') }}">
                                Marketing Pitches
                            </a>
                        </li>
                    </ul>
                ...
                <!-- Contact page -->
                <li class="side-nav-menu-item border-bottom border-light">
                    <a class="side-nav-menu-link media align-items-center" href="{{ route('admin.contactus') }}">
                        <span class="side-nav-menu-icon d-flex mr-3">
                ...
                <li class="side-nav-menu-item side-nav-has-menu border-bottom border-light">
                    ...
                    <!-- UI Components: subComponents -->
                    <ul id="faqComponents" class="side-nav-menu side-nav-menu-second-level mb-0" style="display:block;">
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('admin.new-faq') }}">
                                Create New FAQ
                            </a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('admin.faqs') }}">
                                FAQs
                            </a>
                        </li>
                        <li class="side-nav-menu-item">
                            <a class="side-nav-menu-link" href="{{ route('admin.faq-page') }}">
                                FAQ Page
                            </a>
                        </li>
                    </ul>
                ...
                <li class="side-nav-menu-item side-nav-has-menu border-bottom border-light">
                    <a class="side-nav-menu-link media align-items-center" href="#"
                       data-target="#testimonialComponents">
                        <span class="side-nav-menu-icon d-flex mr-3">
                    ...
                    <!-- UI Components: subComponents -->
                    <ul id="testimonialComponents" class="side-nav-menu side-nav-menu-second-level mb-0" style="display:block;">
                        <li class="side-nav-menu-item">
                          <a class="side-nav-menu-link" href="{{ route('admin.new-testimony') }}">Create Testimonial</a>
                        </li>
                        <li class="side-nav-menu-item">
                          <a class="side-nav-menu-link" href="{{ route('admin.testimonials') }}">List Testimonials</a>
                        </li>
                    </ul>
                    <!-- End UI Components: subComponents -->
                </li>
