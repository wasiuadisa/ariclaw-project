...
@yield('extra_meta')
    ...
    <link rel="icon" href="{{ asset('storage/public_template/img/' . $siteSettingsMiddlewareData->favicon_logo) }}">
    <!-- Bootstrap CSS -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="{{ route('index') }}"> <img src="{{ asset('storage/public_template/img/' . $siteSettingsMiddlewareData->header_logo_filename) }}" alt="{{ $siteSettingsMiddlewareData->header_logo_alt_text }}"> </a>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-6 col-xl-3">
                    <div class="single-footer-widget footer_1">
                        <a href="{{ route('index') }}"> <img src="{{ asset('storage/public_template/img/' . $siteSettingsMiddlewareData->header_logo_filename) }}" alt=""> </a>
                        <p>{{ htmlspecialchars_decode($siteSettingsMiddlewareData->footer_text) }}</p>
                        <div class="social_icon">
                            <a href="{{ htmlspecialchars_decode($siteSettingsMiddlewareData->url_facebook) }}"> <i class="ti-facebook"></i> </a>
                            <a href="{{ htmlspecialchars_decode($siteSettingsMiddlewareData->url_twitter) }}"> <i class="ti-twitter-alt"></i> </a>
                            <a href="{{ htmlspecialchars_decode($siteSettingsMiddlewareData->url_instagram) }}"> <i class="ti-instagram"></i> </a>
                            <a href="{{ htmlspecialchars_decode($siteSettingsMiddlewareData->url_skype) }}"> <i class="ti-skype"></i> </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single-footer-widget">
                        <?php if(count($servicesMiddlewareData) > 1){ ?>
                        <h4>Our Services</h4>
                        <?php }else{ ?>
                        <h4>Our Service</h4>
                        <?php } ?>
                        <ul>
                            @foreach($servicesMiddlewareData as $services)
                            <li><a href="{{ route('public_services') }}">{{{ ucwords(htmlspecialchars_decode($services->title)) }}}</a></li>
                            @endforeach
                        </ul>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single-footer-widget footer_icon">
                        <h4>Contact Info</h4>
                        <p>{{ htmlspecialchars_decode($siteSettingsMiddlewareData->contact_address) }}</p>
                        <ul>
                            <li><a href="#"><i class="ti-mobile"></i>{{ htmlspecialchars_decode($siteSettingsMiddlewareData->contact_phone) }}</a></li>
                            <li><a href="#"><i class="ti-email"></i>{{ htmlspecialchars_decode($siteSettingsMiddlewareData->contact_email) }}</a></li>
                            <li><a href="#"><i class="ti-world"></i>{{ htmlspecialchars_decode($siteSettingsMiddlewareData->contact_website) }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
...
Template edited by <a href="#">Wasiu Adisa</a> | <a>{{ config('app.name') }}</a> demo is developed by <a href="#" target="_blank">Wasiu Adisa</a></p>
