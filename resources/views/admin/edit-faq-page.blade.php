            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-3 mb-md-4">
                        ...
                        <div class="card mb-3 mb-md-4">
                            <form class="form ml-5" method="post" action="{{ route('admin.faq-page_post') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="text" class="h4">Text</label>
                                    <textarea class="form-control border border-dark" id="text" name="text" rows="3">@if(count($errors) > 0){{ old('text') }}@else{{ htmlspecialchars_decode($contents->text) }}@endif</textarea>
                                </div>
