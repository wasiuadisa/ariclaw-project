        ...
        <div class="modal-dialog">
            <div class="modal-content border border-1 border-dark rounded">
                ...
                <div class="modal-body">
                    ...
                    <p><b>Icon</b>: <img src="{{ asset('storage/public_template/img/service_icon/' . $content->icon) }}"/></p>
                ...
                <div class="col-12">
                    <div class="card mb-3 mb-md-4">
                        ...
                        <div class="card-header">
                            <a href="{{ route('admin.new-service') }}" class="btn btn-primary">
                                Create New Service
                            </a>
                        </div>
                          ...
                          <table class="table table-striped table-dark">
                            <thead>
                              <tr>
                                ...
                                <th class="border-top-0 py-2 h4">Details</th>
                      ...
                      <?php $rowNumber = 1; ?>
                        @foreach($contents as $content)
                              <tr>
                                ...
                                <td class="py-3"><img src="{{ asset('storage/public_template/img/service_icon/' . $content->icon) }}"></td>
                                ...
                                <td class="py-3">
                                    <a class="btn btn-light text-dark" href="{{ route('admin.service_edit', $content->id) }}">
                                        <i class="gd-harddrives"></i> Edit
                                    </a>
                                </td>
                                <td class="py-3">
                                    <form action="{{ route('admin.service_delete', $content->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
