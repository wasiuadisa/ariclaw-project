                        ...
                        <div class="card mb-3 mb-md-4">
                            <form class="form ml-5" method="post" action="{{ route('admin.about_post') }}">
                                ...
                                <div class="form-group ">
                                    <label for="dividerTitle" class="h4">
                                        Divider Title
                                    </label>
                                    <input type="text" class="form-control border border-dark" id="dividerTitle" name="dividerTitle" aria-describedby="dividerTitle" value="@if(count($errors) > 0){{ old('dividerTitle') }}@else{{ htmlspecialchars_decode($contents->divider_title) }}@endif">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="text_below_image" class="h4">
                                        Text under image
                                    </label>
