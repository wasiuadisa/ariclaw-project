        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="{{ asset('storage/public_template/img/team/' . $content->image_filename) }}">
                </div>
                <div class="modal-body">
                    <p><b>Email address: </b>{{ htmlspecialchars_decode($content->email) }}</p>
                    <p><b>Skype: </b>{{ htmlspecialchars_decode($content->skype) }}</p>
                    <p><b>Twitter: </b>{{ htmlspecialchars_decode($content->twitter) }}</p>
                    <p><b>Instagram: </b>{{ htmlspecialchars_decode($content->instagram) }}</p>
                </div>
                <div class="modal-header">
