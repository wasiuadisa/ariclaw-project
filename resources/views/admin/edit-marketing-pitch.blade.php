            ...
            <div class="row">
                <div class="col-12">
                    <div class="card mb-3 mb-md-4">
                        ...
                        <div class="card mb-3 mb-md-4">
                            <form class="form ml-5" method="post" action="{{ route('admin.marketing-pitch_post', $contents->id) }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    <a target="_blank" href="https://www..com">
                                        <i class="gd-back"></i> 
                                        View Icon Library
                                    </a>
                                </div>
                                <div class="form-group">
                                    <label for="icon" class="h4">Marketing Icon</label>
                                    <input type="text" class="form-control border border-dark" id="icon" name="icon" aria-describedby="icon" value="@if(count($errors) > 0){{ old('icon') }}@else{{ htmlspecialchars_decode($contents->icon) }}@endif">
                                </div>
