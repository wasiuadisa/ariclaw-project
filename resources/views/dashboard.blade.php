...
<div class="modal fade" id="faqModal" tabindex="-1" aria-labelledby="faqModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="faqModalLabel">FAQs & FAQ page</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p><a class="btn btn-primary text-white" href="{{ route('admin.faq-page') }}">Open FAQ Page Editing</a></p>
                <p><a class="btn btn-primary text-white" href="{{ route('admin.faqs') }}">Open FAQs page</a></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
...
<div class="modal fade" id="contactusModal" tabindex="-1" aria-labelledby="contactusModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><a class="btn btn-primary text-white" href="{{ route('admin.contactus') }}">View Contact Us Page Editing</a></p>
                <p><a class="btn btn-primary text-white" href="{{-- route('admin.contactus-messages') --}}">View Contact Us Messages (In development)</a></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
                        ...
                        <div class="card mb-3 mb-md-4 pl-3 pr-3">
                          <table class="table table-striped table-dark">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="py-2">3</td>
                                <td class="py-2">Marketing Pitches</td>
                                <td class="py-2">
                                    <a class="btn btn-primary btn-block text-white" href="{{ route('admin.marketing-pitches') }}">Open Marketing </a>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-2">4</td>
                              ...
                              <tr>
                                <td class="py-2">5</td>
                                <td class="py-2">FAQ Page &  FAQs</td>
                                <td class="py-2">
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#faqModal">
                                        Open FAQs or FAQ page
                                    </button>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-2">6</td>
                                <td class="py-2">Testimonial</td>
                                <td class="py-2">
                                    <a class="btn btn-primary btn-block text-white" href="{{ route('admin.testimonials') }}">Open Testimonials Page</a>
                                </td>
                              </tr>
                              <tr>
                                <td class="py-2">7</td>
