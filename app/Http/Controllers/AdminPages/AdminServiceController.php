...
class AdminServiceController extends Controller
{
    ...
    public function newServiceFormProcessing(ServiceFormRequest $request)
    {
        ...
        $destinationPath = public_path('storage/public_template/img/service_icon/');
    ...
    public function storeServiceForm(ServiceFormRequest $request, $serviceID)
    {
        ...
        /*******************************************************/
        session()->flash('info', 'Good job! '. htmlspecialchars_decode($request->input('title')) . '\'s service data has been updated, successfully.');
    ...
    public function deleteService(Request $request, $id)
    {
        ...
        $pathToFile = public_path('storage/public_template/img/service_icon/' . $images_db_contents->icon);
