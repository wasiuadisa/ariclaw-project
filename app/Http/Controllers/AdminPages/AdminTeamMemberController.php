...
class AdminTeamMemberController extends Controller
{
    ...
    public function newTeamMemberFormProcessing(TeamMemberFormRequest $request)
    {
        ...
        $newTeamMember->email           = htmlspecialchars($request->input('email'), ENT_SUBSTITUTE);
        $newTeamMember->fullname        = $clean_fullname;
        $newTeamMember->twitter         = htmlspecialchars($request->input('twitter'), ENT_SUBSTITUTE);
        $newTeamMember->skype           = htmlspecialchars($request->input('skype'), ENT_SUBSTITUTE);
        $newTeamMember->instagram       = htmlspecialchars($request->input('instagram'), ENT_SUBSTITUTE);
    ...
    public function newTeamMemberImageFormProcessing(ImageFormRequest $request)
    {
        ...
        $destinationPath = public_path('storage/public_template/img/team/');
    ...
    public function storeTeamMember(TeamMemberFormRequest $request, $teamMemberID)
    {
        ...
        $dataForTeamMemberTable = array(
            ...
            'email' => filter_var($request->input('email'), FILTER_SANITIZE_SPECIAL_CHARS, FILTER_FLAG_ENCODE_LOW),
            'twitter' => filter_var($request->input('twitter'), FILTER_SANITIZE_SPECIAL_CHARS, FILTER_FLAG_ENCODE_LOW),
            'skype' => filter_var($request->input('skype'), FILTER_SANITIZE_SPECIAL_CHARS, FILTER_FLAG_ENCODE_LOW),
            'instagram' => filter_var($request->input('instagram'), FILTER_SANITIZE_SPECIAL_CHARS, FILTER_FLAG_ENCODE_LOW),
            'updated_at' => now()
        );
    ...
    public function deleteTeamMember(Request $request, $id)
    {
        ...
        $pathToFile = public_path('storage/public_template/img/team/' . $images_db_contents->image_filename);
