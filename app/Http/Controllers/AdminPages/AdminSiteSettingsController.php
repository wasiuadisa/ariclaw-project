...
class AdminSiteSettingsController extends Controller
{
    ...
    public function storeSiteSettingsEditForm(SiteSettingPageFormRequest $request)
    {
        ...
        $dataForSiteSettingPageTable = array(
            ...
            //////////////////////////////////////
            'footer_text' => filter_var($request->input('footer_text'), FILTER_SANITIZE_SPECIAL_CHARS,           FILTER_FLAG_ENCODE_LOW),
            'url_facebook' => filter_var($request->input('facebook_address'), FILTER_SANITIZE_SPECIAL_CHARS,           FILTER_FLAG_ENCODE_LOW),
            'url_twitter' => filter_var($request->input('twitter_address'), FILTER_SANITIZE_SPECIAL_CHARS,           FILTER_FLAG_ENCODE_LOW),
            'url_instagram' => filter_var($request->input('instagram_address'), FILTER_SANITIZE_SPECIAL_CHARS,           FILTER_FLAG_ENCODE_LOW),
            'url_skype' => filter_var($request->input('skype_address'), FILTER_SANITIZE_SPECIAL_CHARS,           FILTER_FLAG_ENCODE_LOW),
        ...
        // Do it here
        /*******************************************************/
        session()->flash('info', 'Good job! The Site Setting page info has been updated, successfully.');
